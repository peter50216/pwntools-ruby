  ...
  module Shellcraft
    class Shellcraft
      ...
      def method_missing(method, *args, &block)
        ...
        return common_module.send(method, *args, &block) if common_module.singleton_methods.include?(method)
        os_module = arch_module.const_get(context.os.capitalize)
        return os_module.send(method, *args, &block) if os_module.singleton_methods.include?(method)
        super
      end
